...
const {GetFormData} = require('./form_data/GetFormData.js')
...
module.exports = {
   ...
   getFormInfoNMembers: async function(req, res,  pool, form_id = req.params.id){
      ...
      var form_getter = new GetFormData();
      form_getter.formid = form_id;
      return form_getter.getFormDetail(req.isAuthenticated()?req.user[0].id:-1)
   },
